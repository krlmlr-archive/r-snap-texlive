...
\def\startfont{\font\testfont=\fontname \spaceskip=0pt
  \leftline{\sevenrm Test of \fontname\unskip}
  \medskip
...
\def\domix#1{\par\chardef\0=\background \n=\starting
  \loop \chardef\1=\n %
%moje zmena
\setbox0=\hbox{\1}\def\delej{#1\endgraf}\ifdim\wd0=0pt \ifdim\ht0=0pt \ifdim\dp0=0pt \let\delej\relax \fi \fi \fi
  \delej\ifnum \n<\ending \advance\n 1 \repeat \ifnum\n=90\0'\endgraf\fi}
...
%\ifx\noinit!\else\init\fi
\def\bskfont#1{\def\fontname{#1}\startfont\table}
\def\ep{\vfill\eject}
\bskfont{bskr10}\ep
\bskfont{bski10}\ep
\bskfont{bskiu10}\ep
\bskfont{bskrw10}\ep
\bskfont{bskr10-T1}\ep
\bskfont{bskr10-TS1}\ep
\bskfont{bsksc10}\ep
\bskfont{bskmi10}\ep
\bskfont{bsksy10}\ep
\bskfont{bskms10}\ep
