...
\item \textbf{Herbert Voﬂ} also for answering my stupid questions on d.c.t.t.
\end{itemize}

I also want to thank the following persons for bug reports, feature requests, ...: Til Birnstiel, Jannis von Buttlar, Gabriel Cardona, Thomas Feller, Florent Chervet, Jin-Hwan Cho, Marcel Dausend, Andrew Dawson, diabonas, Max Funk, Zvi Gilboa, Thomas Kˆnig, Marc-AndrÈ Michel, Guillaume Millet, Fritz Moore, Michael Niedermair, Stefan Pinnow, RenÈ Schwarz
\clearpage
\section{Options}
...
Of course, it also works in equations: \[\pdftooltip[mathstyle=\displaystyle]{\sum_{i=1}^{n}i=\frac{1}{2}n\cdot(n+1)}{little Gauﬂ}\]
